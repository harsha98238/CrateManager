...
/*error reset*/
if ((digitalRead(pushButton) == false or ResetSwitch == true) and ((error == true) or (BeltError == true) or (errors3 = true) or(errors4 = true) or (errorFC == true) or (Tray1LightError == true) or (Tray2LightError == true)or (Tray3LightError == true)))
  { 
    ResetSwitch = false;
    BeltError = false;
    FullCopError = false;
