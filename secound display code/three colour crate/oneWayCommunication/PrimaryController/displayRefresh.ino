void displayCount()
{
  ...
  sprintf(tempBuffer,"%-5d",color1Cnt);
  String colour1Temp = tempBuffer;
  sprintf(tempBuffer,"%-5d",color2Cnt);
  String colour2Temp = tempBuffer;
  sprintf(tempBuffer,"%-5d",color3Cnt);
  String colour3Temp = tempBuffer;
  sprintf(tempBuffer,"%-5d",FullCopCount);
  String FullCopCountTemp = tempBuffer;
  sprintf(tempBuffer,"%-5d",krichiCnt);
  String krichiCntTemp = tempBuffer;
  sprintf(tempBuffer,"%-5d",BinSize);
