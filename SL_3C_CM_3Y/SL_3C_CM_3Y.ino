...
//TO TRIGGER SHUTTER4 for color3COP
  if (Object3flag1 == true and digitalRead(obj3) == false and color3identified == true and yarn3flag == false)
      {
...
if (CopStorage3Count >= 4 and CopStorage3Shutterflag1 == false)
{
  CopStorage3Count = 0;
}
...
if( CopStorage3Count >= 4 and crate3error == false and digitalRead(crate3) == false )
{
